...
public class FillTheForm {
    ...
    public static Performable WithAccountInformation(String title, String name, String email, String password, String date) {
    ...
    public static Performable WithPaymentDetails(String lastName, String cardNumber, String cvc, String expiration) {
