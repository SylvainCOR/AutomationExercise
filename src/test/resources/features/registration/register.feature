Feature: User Registration
  ...
  Scenario: Test Case 1: Register User
    ...
    When he enters name "johnwick" and email "johnwick11@gmail.com"
    And he clicks on Signup button
    Then he can see "ENTER ACCOUNT INFORMATION" on signup page
    When he fills account information details: Title "Mr", Name "johnwick", Email "johnwick11@gmail.com", Password "secret", Date of birth "07/07/1977"
    ...
    Then he can see "Logged in as" "johnwick" on home page
